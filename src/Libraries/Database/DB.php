<?php
namespace DongPHP\Libraries\Database;

use DongPHP\Libraries\Database\Driver\Processor;
...
class DB
{
    ...
    public function __construct()
    {
        ...
        $container->bind('db.connector.mysql_hash',  'DongPHP\Libraries\Database\Driver\Connector');
        $container->bind('db.connection.mysql_hash', 'DongPHP\Libraries\Database\Driver\Connection');
    ...
    public static function setPaginator()
    {
