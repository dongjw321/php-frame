...
require_once(dirname(__FILE__) . "/upmp_core.php");
...
class UpmpService
{
    ...
    /**
     * 交易接口处理
     * @param string  $req 请求要素
     * @param array $resp 应答要素
     * @return bool 是否成功
     * @throws Exception
     */
    ...
    /**
     * 交易查询处理
     * @param $req array 请求要素
     * @param $resp array 应答要素
     * @return bool 是否成功
     * @throws Exception
     */
