...
include_once(APP_PATH . "Config/Sdk/upmp.config.php");
/**
 * 除去请求要素中的空值和签名参数
 * @param array $para
 * @return array 去掉空值与签名参数后的请求要素
 */
 ...
 * @param $para array 请求要素
 * @param $sort bool 是否需要根据key值作升序排列
 * @param $encode string 是否需要URL编码 $encode
