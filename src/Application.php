...
class Application
{
    ...
    {
        $this->default_controller = ucfirst($controller);
        return $this;
    }
    ...
    {
        $controller || $controller = $this->namespace . '\Controller\\'.ucfirst($this->default_controller).'Controller';
    ...
    {
        $this->method = $method ? $method : $this->default_method;
        return $this;
    }
    ...
    private function execute(array $route)
    {
        ...
        if ($this->muti_version) {
            list($controller, $method) = $this->mutiVersion($this->getController(), $this->getMethod(), $rc->getMethods(), $this->muti_version);
        }
